...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ImageView image_check = (ImageView)convertView.findViewById(R.id.check_image);
        ...
        if(list.get(position).getIsSelected()==true){
            image_check.setColorFilter(Color.parseColor("#8795ff"));
        }
        else
        {
            image_check.setColorFilter(null);
        }
        /*final CheckBox cbProductChecked = (CheckBox)convertView.findViewById(R.id.productChecked);
        cbProductChecked.setFocusable(false);
