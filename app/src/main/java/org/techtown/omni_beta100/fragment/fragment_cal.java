...
import org.techtown.omni_beta100.adapter.CalendarAdapter;
import org.techtown.omni_beta100.util.Keys;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.GregorianCalendar;

import static org.techtown.omni_beta100.util.DateUtil.CALENDAR_HEADER_FORMAT;
import static org.techtown.omni_beta100.util.DateUtil.getDate;
...
public class fragment_cal extends Fragment {
    ...
    public void setCalendarList(GregorianCalendar cal) {
        ...
        getDate(cal.getTimeInMillis(), CALENDAR_HEADER_FORMAT);
        //System.out.println("달력" + cal.getTimeInMillis());
